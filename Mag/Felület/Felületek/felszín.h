...
nyilvános kettőspont
	...
	//űr DrawSetTextFont nyitózárójel HFont hFont zárózárójel kódblokkeleje
	...
	//HFont FontCreate nyitózárójel  zárózárójel kódblokkeleje
	//	visszatér segéd kettőspontkettőspont VFunkcióHivás kisebbmint HFont nagyobbmint  nyitózárójel ez vessző 71 zárózárójel sorvége
	//kódblokkvége

	//bool SetFontGlyphSet nyitózárójel HFont hFont vessző const char mutató  szWindowsFontName vessző egész iTall vessző egész iWeight vessző egész iBlur vessző egész nScanLines vessző egész iFlags vessző egész nRangeMin = 0 vessző egész nRangeMax = 0 zárózárójel kódblokkeleje
	//	visszatér segéd kettőspontkettőspont VFunkcióHivás kisebbmint bool nagyobbmint  nyitózárójel ez vessző 72 vessző hFont vessző szWindowsFontName vessző iTall vessző iWeight vessző iBlur vessző nScanLines vessző iFlags vessző nRangeMin vessző nRangeMax zárózárójel sorvége
	//kódblokkvége

	//űr GetTextSize nyitózárójel HFont hFont vessző const wchar_t mutató  wszText vessző egész& iWide vessző egész& iTall zárózárójel kódblokkeleje
